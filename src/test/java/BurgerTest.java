...
public class BurgerTest {
    ...
    public void getReceiptBurgerTest() {
        Burger burger = new Burger();
        String name = "Булочка из печи";
        String cutlet = "Котлета с секретом";
        String mayo = "Тысяча островов";
        Bun bun = new Bun(name, 2.84f);
        Ingredient filling = new Ingredient(IngredientType.FILLING, cutlet, 39.44f);
        Ingredient sauce = new Ingredient(IngredientType.SAUCE, mayo, 589.99f);
        burger.setBuns(bun);
